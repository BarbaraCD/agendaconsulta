  ...
  const handleAgendarConsulta = () => {
    if (selectedDoctor && selectedPatient && selectedDate && selectedTime) {
      const newAppointment: AppointmentsProps = {
        ...
        data: selectedDate,
        hour: selectedTime,
        symptoms: '', // Adicione aqui os sintomas que o usuário selecionar, se aplicável
      };

      createAppointment(newAppointment)
        .then(() => {
          // Lógica para exibir uma mensagem de sucesso ou redirecionar para outra página
          console.log('Consulta agendada com sucesso!');
        })
        .catch((error) => {
          // Lógica para exibir mensagem de erro ou tratamento de erro
