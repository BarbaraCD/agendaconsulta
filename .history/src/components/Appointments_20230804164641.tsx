...
export const Appointments: React.FC = () => {
  ...
  const handleDoctorSelect = (value: string) => {
    ...
    setSelectedDoctor(selectedDoc ? selectedDoc.id : -1); // Use o ID do médico selecionado ou -1 (nenhum valor selecionado)
  };
  
  const handlePatientSelect = (value: string) => {
    const selectedPat = patients.find((pat) => pat.name === value);
    setSelectedPatient(selectedPat ? selectedPat.id : -1); // Use o ID do paciente selecionado ou -1 (nenhum valor selecionado)
  };
