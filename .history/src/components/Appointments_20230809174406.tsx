...
export const CreateAppointments: React.FC = () => {
  ...
  function isWeekday(date: Date) {
    ...
    return day !== 0 && day !== 6; // Retorna verdadeiro para os dias de semana (segunda a sexta-feira)
  }

  function isAppointment(date: Date, appointments: AppointmentsProps[]) {
    const selectedDateTime = date.getTime();
    return appointments.some(appointment => {
      const appointmentDateTime = new Date(appointment.date).getTime();
      return (
        format(appointmentDateTime, 'dd/MM/yyyy HH:mm') ===
      ...
      <APBody>
        ...
        <DatePicker
          ...
          filterDate={date => {
            ...
            return !isAppointment(newDateTime, appointments)
          }}
        />
        <Input
