...
export const AppointmentsCalendar = () => {
  ...
  return (
    <CalendarStyled>
      ...
      <StyledModal title={<h3>"Detalhes da Consulta"</h3>} open={modalVisible} onCancel={closeModal} footer={null}>
        {selectedAppointment && (
          <div>
            ...
            <div>
              ...
              <button onClick={() => handleDeleteAppointment(selectedAppointment.id)}>
                <DeleteOutlined />
              </button>
            </div>
          </div>
