...
export function CreateDoctor() {
  const [doctorsList, setDoctorsList] = useState<DoctorsProps[]>([]);
  ...
  return (
    <DocContainer>
      <InputDoctors
        ...
        onSpecializationChange={(value) => setNewDoctor({ ...newDoctor, specialization: value })}
      />
