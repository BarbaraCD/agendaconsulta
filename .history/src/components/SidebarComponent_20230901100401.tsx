import { HomeOutlined, MenuOutlined, ScheduleOutlined, UserOutlined } from '@ant-design/icons'
import { StyledList, StyledItem, StyledSidebar, ContainerHeader, StyleLink } from '../styles/SidebarStyled'
