import { DoctorsProps } from '../components/DoctorTable'
import { DoctorSchemaType } from '../components/InputDoctors'
...
export async function createDoctor(data: DoctorSchemaType) {
  return api.post('/doctor', data)
}

export async function updateDoctor(id: number, data: DoctorSchemaType) {
  try {
